...
namespace Terminal {
    ...
    class Cursor {
    public:
        static constexpr const auto END = "\033[9999C";
    ...
    class Symbols {
    public:
        static constexpr const auto BELL        = "\U0001F514";
        ...
        static constexpr const auto RIGHT_ARROW = "\u2192";
        static constexpr const auto TIP         = "\U0001F4A1";
